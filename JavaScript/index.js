...
$.getJSON("https://inskrtch-de394-default-rtdb.firebaseio.com/index.json?print=pretty", function (data) {
  ...
  $.each(postVideo, function (i, data) {
    $("#embed").append(
      '<div class="card-video"><div class="videos"><img src="' +
        data.urlGambar +
        '"/><div class="play"><a href="#"><img src="/Img/play-circle-solid.svg" /></a></div></div><div class="title-video"><i class="fas fa-share"></i><a href="' +
        data.urlVideo +
        '">' +
        data.urlNama +
        "</a></div></div>"
